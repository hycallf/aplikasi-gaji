            ...
            <nav class="flex items-center justify-end gap-4">
                @auth
                    @if (Auth::user()->role === 'operator')
                        ...
                        <a href="{{ route('dashboard') }}" class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] ...">
                            Dashboard
                        </a>
                    @else
                        {{-- Tombol untuk Karyawan/Dosen --}}
                        <a href="{{ route('user.dashboard') }}" class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] ...">
                            Dashboard Saya
                        </a>
                    @endif
                @else
